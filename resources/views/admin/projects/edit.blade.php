...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div><h4 class="mb-0">تعديل: {{ $project->title }}</h4></div>
            <div class="ms-auto">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="url" name="code_url" class="form-control" value="{{ old('code_url', $project->code_url) }}">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">التقنيات المستخدمة (Tags)</label>
                                <input type="text" name="tags" class="form-control" value="{{ old('tags', $project->tags) }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card custom-card">
                        <div class="card-body">
                            ...
                            <button type="submit" class="btn btn-primary w-100 mb-2">
                                <i class="bi bi-save me-2"></i>تحديث المشروع
                            </button>
